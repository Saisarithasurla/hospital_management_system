...
function Login() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch("https://hospital-management-system-6jw8.onrender.com/api/register/", {
        method: "POST",
        headers: {
  ...
  const handleLogin = async (e) => {
    ...
    try {
     const response = await fetch("https://hospital-management-system-6jw8.onrender.com/api/token/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
